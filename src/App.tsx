    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-md shadow-md py-3' : 'bg-transparent py-5'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          {logoUrl ? (
            <img src={logoUrl} alt="HKIMID Logo" className="w-10 h-10 object-contain" referrerPolicy="no-referrer" />
          ) : (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              {logoUrl ? (
                <img src={logoUrl} alt="HKIMID Logo" className="w-12 h-12 object-contain" referrerPolicy="no-referrer" />
              ) : (
